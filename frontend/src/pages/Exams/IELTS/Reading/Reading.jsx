...
function Reading() {
  ...
  <section class="details">
    <div class="details-card">
      <div class="details-content">
        <h3 class="card__title">IELTS Reading: About</h3>
        <p className="low_p">Updated on Dec 26, 2023, 05:24</p>
       <li>The IELTS Reading test is part of the four-module IELTS exam. The 60-minute reading test features 3 sections with 3 or more passages. While the format and pattern remain the same for both IELTS General and Academic versions, 
        the question types and passages featured differ. </li>
       <li>On this Page, we’ll explain everything you need to know to prepare
         for IELTS Reading! Let’s get started. </li>
      </div>
    </div>
  </section>
  ...
  <section class="details">
    ...
    <div class="details-card">
      <div class="details-content">
        <h2 class="card__title">1.IELTS Reading Pattern</h2>
    ...
    <div class="details-card">
      <div class="details-content">
        <h2 class="card__title">2.IELTS Academic Reading VS IELTS General Reading</h2>
        <div className="header-image-container">
    <img className="header-image" src={Image} alt="Header Image" />
  </div>
        <div class="card_text">
...
<section class="details">
  ...
  <div class="details-card">
    <div class="details-content">
      <h2 class="card__title">3. IELTS Reading Tasks</h2>
      <div className="header-image-container">
  <img className="header-image" src={Image} alt="Header Image" />
</div>
      <div class="card_text">
...
<section class="details">
  ...
  <div class="details-card">
    <div class="details-content">
      <h2 class="card__title">4. IELTS Reading Band Score</h2>
      <div className="header-image-container">
  <img className="header-image" src={Image} alt="Header Image" />
</div>
      <div class="card_text">
          <p>There are two versions of the IELTS writing test – Academic
             and General. IELTS Writing comprises two tasks. </p>
         <p> Task 2 is the same for both tests, but Task 1 differs.</p>
         <p>The table below shows the IELTS Writing Pattern for a better understanding:</p>
        ...
        <tbody>
          ...
          <tr>
            ...
            <p>Here is what the tasks look like </p>
              <p><li>Task 1: Summarise a visual or process 
                (Academic test) or write a letter (General test).</li>
                <li>Task 2: Compose a complete essay (Same for Academic and General tests.)</li>
              </p>
              <p>You will be evaluated on whether your ideas are connected and flow together, your vocabulary and grammar usage, and whether 
                you have met all the task requirements.</p>
                <p>This table below a comprehensive
                   understanding of the tasks in the IELTS Writing test:</p>
        ...
        <tbody>
          <tr>
            <td>Task 1 (Academic)</td>
            <td>150</td>
            <td>20 minutes</td>
            <td>Describe the information in a graph or chart</td>
          </tr>
          <tr>
            <td>Task 2 (Academic)</td>
            <td>150</td>
            <td>20 minutes</td>
            <td>Describe the information in a graph or chart</td>
          </tr>
          <tr>
            <td>Task 3 (Academic)</td>
            <td>150</td>
            <td>20 minutes</td>
            <td>Describe the information in a graph or chart</td>
          </tr>
